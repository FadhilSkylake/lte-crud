    ...
    <body id="page-top">
        ...
        <header class="masthead">
            <div class="container">
                ...
                <div class="masthead-subheading">HOME | GALLERY</div>
            </div>
        </header>
<section class="page-section" id="services">
    <div class="container">
    <div class="text-center">
        <h3>KEGIATAN SINEGRITAS KOPERASI DAN UMKM</h3>
    </div>
        <img src="assets/img/1.jpeg" class="img-thumbnail" alt="..." width="445" height="500">
        <img src="assets/img/4.jpg" class="img-thumbnail" alt="..." width="445" height="500">
        <img src="assets/img/2.jpg" class="img-thumbnail" alt="..." width="395" height="450">
        <hr size="20px">
    <div class="text-center">
        <h3>CEREMONY</h3>
    </div>
        <img src="assets/img/3.jpg" class="img-thumbnail" alt="..." width="445" height="500">
        <img src="assets/img/4.jpg" class="img-thumbnail" alt="..." width="445" height="500">
        <img src="assets/img/2.jpg" class="img-thumbnail" alt="..." width="395" height="450">
        <hr size="20px">
    <div class="text-center">
