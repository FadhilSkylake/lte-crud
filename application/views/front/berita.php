...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <header class="masthead">
            <div class="container">
                <div class="masthead-heading">BERITA</div>
                <div class="masthead-subheading">HOME | BERITA</div>
            </div>
        </header>
        <section class="page-section" id="services">
            <div class="container">
                <div class="text-center">
                    <h2 class="section-heading text-uppercase">HALAMAN BERITA DKUPP SUBANG</h2>
                </div>
                <img src="assets/img/1.jpeg"  alt="..." width="1300" height="500">
