...
<html lang="en">
    <head>
        ...
        <title>DINAS KOPERASI UMKM PERDAGANGAN DAN PERINDUSTRIAN KABUPTEN SUBANG</title>
        <!-- Favicon-->
        <link rel="icon" type="image/x-icon" href="<?php echo base_url('assets/img/dinas/logo.png')?>" >
    ...
    <body id="page-top">
        ...
        <section class="page-section" id="services">
            <div class="container">
                <div class="text-center">
                    <h2 class="section-heading text-uppercase">DATA BIDANG & SEKRETARIAT</h2>
                </div>
        ...
        <div class="container">
            <hr size="20px">
        <div class="text-center">
        <h2 class="section heading text-uppercase">SEJARAH DKUPP</h2>
        <p> 1. Undang-Undang Nomor 14 Tahun 1950 tentang Pembentukan Daerah-Daerah Kabupaten Dalam Lingkungan Propinsi Djawa Barat, sebagaimana telah diubah dengan Undang-Undang  Nomor  4  Tahun  1968,  tentang  Pembentukan Kabupaten Purwakarta   dan Kabupaten  Subang, dengan Mengubah Undang-Undang Nomor 14 Tahun 1950 tentang Pembentukan Daerah-Daerah Kabupaten Dalam Lingkungan Propinsi Djawa Barat; <br>
            2. Undang-Undang Nomor 5 Tahun 2014 tentang Aparatur Sipil Negara; <br>
            3. Undang-Undang Nomor 23 Tahun 2014 tentang Pemerintahan Daerah; <br>
            4. Peraturan Pemerintah Nomor 18 Tahun 2016 tentang Perangkat Daerah; <br>
            5. Peraturan Daerah Kabupaten Subang Nomor 7Tahun 2016, tentang Pembentukan dan Susunan Perangkat Daerah Kabupaten Subang; <br>
            6. Peraturan BupatiSubang Nomor 32 Tahun 2016, tentang Susunan Organisasi Perangkat Daerah Dinas.</p>
        </div>
        <hr size="20px">
        <div class="text-center">
            <h2 class="section heading text-uppercase">PERATURAN-PERATURAN DKUPP Kab.SUBANG</h2>
        ...
        <hr size="20px">
        <div class="text-center">
            <h2 class="section heading text-uppercase">PERANAN DKUPP</h2>
        <p>Lorem ipsum dolor sit amet consectetur.Lorem ipsum dolor sit amet consectetur.Lorem ipsum dolor sit amet consectetur.<br>
            Lorem ipsum dolor sit amet consectetur.Lorem ipsum dolor sit amet consectetur.Lorem ipsum dolor sit amet consectetur.<br>   
            Lorem ipsum dolor sit amet consectetur.Lorem ipsum dolor sit amet consectetur.Lorem ipsum dolor sit amet consectetur.<br>
        </p>
        ...
        <img src="<?php echo base_url('assets/img/dinas/1.jpeg')?>" alt="..." width="1300" height="500">
                <h2>Pelatihan UMKM</h2>
                <p> Lorem ipsum, dolor sit amet consectetur adipisicing elit. Incidunt facilis ea alias, a ullam tenetur dolore aliquid officiis autem sunt iusto ducimus similique neque. Excepturi minima reiciendis qui iusto <a href="">Read More</a> <br>
                </p>
                
                <br>
                <img src="<?php echo base_url('assets/img/dinas/basreng.jpg')?>"  alt="..." width="1300" height="500">
                <h2>Basreng</h2>
                <p> Lorem ipsum, dolor sit amet consectetur adipisicing elit. Incidunt facilis ea alias, a ullam tenetur dolore aliquid officiis autem sunt iusto ducimus similique neque. Excepturi minima reiciendis qui iusto <a href="">Read More</a> <br>
                </p>
